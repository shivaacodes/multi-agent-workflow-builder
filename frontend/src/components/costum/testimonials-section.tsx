...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "flowtype has revolutionized how we handle custom contracts. The automation saves us hours every week and eliminates errors completely.",
      name: "Sarah Chen",
  ...
  return (
    <div className="w-full border-b border-lines flex flex-col justify-center items-center">
      {/* Testimonial Content */}
      <div className="self-stretch px-4 py-16 md:py-20 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            ...
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-text-primary text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              >
                <div className="self-stretch justify-center flex flex-col text-text-primary text-lg font-medium leading-[26px] font-sans">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-text-secondary text-lg font-medium leading-[26px] font-sans">
          ...
          <div className="pr-6 justify-start items-start gap-[14px] flex">
            <button
              ...
              className="w-9 h-9 shadow-[0px_1px_2px_rgba(0,0,0,0.08)] overflow-hidden rounded-full border border-lines justify-center items-center gap-2 flex hover:bg-gray-50 transition-colors"
            >
